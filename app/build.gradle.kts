...
android {
    namespace = "com.hospitec.clinica"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.hospitec.clinica"
        minSdk = 31
        targetSdk = 35
        versionCode = 2
        versionName = "2.0.0"
        ...
        // Configuración de vector drawables
...
dependencies {
    ...
    // Retrofit y networking profesional
    ...
    // Timber para logging profesional
